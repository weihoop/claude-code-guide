...
- 📋 [**Claude Code 编程最佳实践**](docs/claude-code-best-practices.md) - 完整的项目配置、文件组织和开发范式
- ⚡ [**快速参考卡**](docs/quick-reference.md) - 一页纸速查核心配置（推荐收藏）

本文档聚焦于**使用技巧和优化策略**，如需了解**项目组织和配置规范**，请参考上述文档。
